...
public class GameplayController : MonoBehaviour {
	...
	void Difficulty(){
		...
		if(GameController.instance.currentScore <= 10000 && GameController.instance.currentScore >= 15000){
			background.GetComponent<Background> ().speed = 0.7f;
			obstacleSpawner.GetComponent<ObstacleSpawner> ().delay = 2f;
		}


		if(GameController.instance.currentScore <= 30000 && GameController.instance.currentScore >= 45000){
			background.GetComponent<Background> ().speed = 0.8f;
			obstacleSpawner.GetComponent<ObstacleSpawner> ().delay = 1.5f;
		}
	...
	void RewardNewDrone(){
		if(!GameController.instance.drones [1]){
			if(GameController.instance.currentScore <= 1499 && GameController.instance.currentScore >= 700){
		...
		if(!GameController.instance.drones [2]){
			if(GameController.instance.currentScore <= 999999999 && GameController.instance.currentScore >= 1500){
